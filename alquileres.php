...
<head>
    ...
    <link rel="stylesheet" href="css/style-alquileres.css">
                            ...
                            <div class="rd-navbar-main-element">
                                <div class="rd-navbar-nav-wrap">
                                    <ul class="rd-navbar-nav">
                                        ...
                                        <li class="rd-nav-item active"><a class="rd-nav-link color-nova">Alquileres</a>
                                        </li>
            ...
            <div class="container wide">
                <div style=" background: #f3b284; justify-content: center; " class="row row-md-30 ">
                    <div class="busqueda-propiedad-ayuda">
                        <span class="txt-ayuda"> ¿Queres alquilar tu propiedad con nosotros? <br> ¿Necesitas ayuda con tu busqueda? <br>
                        </span>
            ...
            <div class="container wide">
                <div style=" justify-content: center; margin-top:0px; margin-bottom:0px;" class="row row-md-30 ">
                    ...
                    if (!empty($_GET["varB"])) {
                        ...
                        $sql = "SELECT * FROM inmueble WHERE   (estado=0 or estado=2 )
