<style>
    ...
    .btn-enviar-form-class {
        background: #FF6900 !important;
        border-color: #FF6900 !important;
        font-weight: 700 !important;
    }

    .btn-enviar-form-class:hover {
        background: #eda878 !important;
    }
    ...
    <div class="page">
        ...
        <div class="title-propiedades-destacadas">
            <div class="row margen-fila-imgtasaciones">
                <div class="col-md-6 ">
                    <div class="ubicacion-img-tasacion"><img class="img-tasaciones" src="images/formulario-de-contacto.png " />
                    </div>
                </div>
                ...
                <div class="col-md-6 ">
                    <div class="ubicacion-text">
                        ...
                        <p class="subtitulo-tas">Dejanos tus datos y nos contactaremos<br>a la brevedad.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <form id="frmContacto">
                    <div class="alinear-requisitos">
                        <div class="alinear-label">
                            <span style="font-weight: 800;">Nombre y Apellido:</span>
                        </div>
                        <div>
                            <input class="input-design" required type="text" minlength="2" id="nombre_apellido" name="nombre_apellido" />
                        </div>
                    </div>
                    <div class="alinear-requisitos">
                        <div class="alinear-label">
                            <span style="font-weight: 800;">Celular:</span>
                        </div>
                        <div>
                            <input class="input-design" required type="tel" minlength="5" id="celular" name="celular" />
                        </div>
                    </div>
                    <div class="alinear-requisitos">
                        <div class="alinear-label">
                            <span style="font-weight: 800;">Operación:</span>
                        </div>
                        <div>
                            <input class="input-design" required type="text" id="operacion" name="operacion" />
                        </div>
                    </div>
                    ...
                    <div class="alinear-requisitos ">
                        ...
                        <div>
                            <input class="input-design" required type="text" id="propiedad" name="propiedad" />
                        </div>
                    </div>
                    <div class="alinear-requisitos ">
                        <div class="alinear-label">
                            <span class="" style="font-weight: 800;">Observaciones:</span>
                        </div>
                        <div>
                            <textarea class="input-design" required id="observaciones" name="observaciones" cols="40" rows="5"></textarea>
                        </div>
                    </div>

                    <!-- boton enviar formulario-->

                    <div id="div-enviar" class="alinear-btn-enviar">
                        <button type="submit" id="btn-enviar-form" class="btn btn-primary btn-enviar-form-class">
                            <i class="fa-brands fa-mail-forward" style="font-size: 35px; position: relative; top: 5px;"></i>
                            <span style="    position: relative; bottom: 5px;"> ENVIAR </span></button>

                    </div>
                    <div id="div-enviando" style="display: none;" class="alinear-btn-enviar">
                        <button style="background: #FF6900 !important; border-color: #FF6900 !important;  font-weight: 700;" type="submit" id="btn-enviando-form" class="btn btn-primary">
                            <span> Enviando... </span></button>
