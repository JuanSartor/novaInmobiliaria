...
<html class="wide wow-animation" lang="es">
    ...
    <head>
        ...
        <script>
            function cargarImagenAlternativa(img, id) {
                img.onerror = null; // Evita el bucle infinito
                img.src = 'imagenes-inmuebles/img-secciones/' + id + '.png';
        ...
        <div class="page">
            ...
            <div style="padding: 0px;" class="section section section-lg ">
                <div class="container wide">
                    ...
                    <img class='img-tasaciones' style='margin-top:0px;' src= 'imagenes-inmuebles/img-secciones/$id.jpg'   onerror='cargarImagenAlternativa(this,$id)'/>
                    </a>
