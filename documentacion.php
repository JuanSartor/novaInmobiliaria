...
<head>
    ...
    <link rel="stylesheet" href="css/style-documentacion.css">
    ...
    <div class="page">
        ...
        <div class="title-propiedades-destacadas">
            <div class="row margen-fila-imgtasaciones">
                <div class="col-md-6 ">
                    <div class="ubicacion-img-tasacion"><img class="img-tasaciones" src="images/documentacion.png " />
                    </div>
                </div>
                ...
                <div class="col-md-6 ">
                    <div class="ubicacion-text">
                        ...
                        <p class="subtitulo-tas">Para comenzar a TRABAJAR JUNTOS <br>necesitamos que recopiles <br> la siguiente DOCUMENTACION</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="padding: 0px;" class="section section section-lg">
            <div class="container wide container-mob">
                ...
                <p class="alinear-requisitos">
                    <span style="font-weight: 700;">TITULO DE LA PROPIEDAD</span>(Escritura, Boleto de Compra, Venta, etc.)
                </p>
                <p class="alinear-requisitos">
                    <span style="font-weight: 700;">PLANOS</span>(Mensura, construccion, etc.)
                </p>
                <p class="alinear-requisitos">
                    <span style="font-weight: 700;">IMPUESTOS, TASAS Y SERVICIOS</span>(Foto de impuesto inmobiliario, tasa municipal, luz, agua, gas, expensas, etc.)
                </p>
                <p class="alinear-requisitos">
                    <span style="font-weight: 700;">DNI DE TITULARES</span>(Foto de ambos lados)
                </p>
            ...
            <div class="container wide container-mob">
                ...
                <div style=" background: #f3b284; justify-content: center; " class="row row-md-30 margin-inferior">
                    <p class="alinear-parrafo">
                        Una vez presentada la documentacion requerida podremos <br>
                        comenzar a <span style="font-weight: 700;">TRABAJAR JUNTOS!</span>
                    </p>
                </div>
