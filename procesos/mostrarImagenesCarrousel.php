...
foreach ($archivos as $archivo) {
    ...
    if ($archivo != '.' && $archivo != '..') {
        ...
        echo ' <button title="Eliminar" class="eliminar-imagen" data-id="'. $nuevo_dir. $archivo.'" style="position:relative; bottom:50px; right:30px;" type="button" >
...
$.ajax({
url: 'procesos/deleteImageCarrousel.php',
type: 'POST',
...
$.ajax({
            type:"POST",
            data:{ idInmuebleSeleccionado: idInmueble, imagenSeleccionada:  valorSeleccionado},
